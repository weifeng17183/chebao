...
public class ImageRemarkUtil {
    ...
    // 水印横向位置
    private static int positionWidth = 15;
    // 水印纵向位置
     ...
     *            目标图片路径
     */
    public static void markImageByIcon2(String iconPath, String srcImgPath,
    		String targerPath) {
    	markImageByIcon2(iconPath, srcImgPath, targerPath, null);
    }
    ...
    public static void markImageByIcon(String iconPath, String srcImgPath,
        ...
        try {
            ...
            g.drawImage(img, buffImg.getWidth()-75, buffImg.getHeight()-75, null);
    ...
    public static void markImageByIcon2(String iconPath, String srcImgPath,
    	...
    	try {
    		...
    		System.out.println(buffImg.getWidth());
    		System.out.println(buffImg.getHeight());
    		g.drawImage(img, buffImg.getWidth()-125, positionHeight+20, null);
    		g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER));
    		// 7、释放资源
    		g.dispose();
