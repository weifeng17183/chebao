...
<html>
	...
	<body>
		...
		<div class="helpcontent">
         ...
         <h2>关于我们</h2>
          <ul>
           <li><a href="${base}/about/about?type=company" class="current">公司简介</a></li>
           <li><a href="${base}/about/about?type=course">发展历程</a></li>
           <li><a href="#" >诚聘英才</a></li>
           <li><a href="${base}/about/about?type=contact">联系我们</a></li>
          </ul>
         </div>
         <div class="helpright">
