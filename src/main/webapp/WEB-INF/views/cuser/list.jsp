...
<body class="list">
	...
	<div class="body" style="position: relative;">
		<div class="listBar">
			<form id="listForm" action="${base}/admin/cuser/list?userType=0" method="post"
		...
		<table id="listTable" class="listTable">
			...
			<c:forEach items="${userList}" var="user">
				<tr>
					...
					<td>${user.inviter}</td>
					<td>${user.memo}</td>
					<td><a href="${base}/admin/cuser/info?userId=${user.userId}"
						title="[详情]">[详情]</a> <shiro:hasPermission name="user:update">
							<a href="${base}/admin/cuser/edit?userId=${user.userId}"
								title="[编辑]">[编辑]</a>
						<a href="${base}/admin/cuser/alert?userId=${user.userId}"
						title="[管理车辆]">[管理车辆]</a>
