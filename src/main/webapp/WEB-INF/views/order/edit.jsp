...
<body class="input admin">
	<div class="bar">
	<c:if test="${order.payStatus==2}">评估</c:if><c:if test="${order.payStatus==3}">修改</c:if>订单</div>
	...
	<div class="body">
		<form id="validateForm" name="member"
			action="${base}/admin/order/saveOrder" method="post">
			...
			<div class="findOForders">
				<div class="category">
					...
					<div class="categoryList bj">
						<dl id="fdl">
							<dt>
								<span>非标项目描述:</span><span>非标项目价格:</span><span>非标项目折扣:</span><span>操作</span>
							</dt>
							<dd>
