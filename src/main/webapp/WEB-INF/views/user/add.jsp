		...
		<form id="validateForm" name="member"
			...
			<table class="inputTable">
				<tr>
					<th>车辆图片:</th>
					<td>
						<div class="AddInpnt fl" hidden="hidden">
							<input type="file" class="File" id="file_input" name="picFiles"
								multiple />
						</div>
						<div class="likeUpload" id="likeUpload">
							<ul id="PicUpload">
								<li><img src="${base}/template/mobile/images/camera_03.png"
									width="50" onclick="photo()"></li>
							</ul>
						</div>
					</td>
				</tr>
				...
				<tr>
					<th>颜色:</th>
					<td><input type="text" name="colour" class="formText" value="" /></td>
				</tr>
				<tr>
					<th>发动机号:</th>
