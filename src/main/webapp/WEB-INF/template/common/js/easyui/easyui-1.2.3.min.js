 ...
 * 
 */
 /* 2011.06.28 update：支持在标签中定义全局的editor变量 */
 /* 2011.06.28 update：支持field="customer.name"格式 */
 /* 2011.06.29 update：改正了同时删除多个新增项时出错的问题 */
 /* 2011.06.30 update：支持filed="customer.name"格式，保存row["customer.name"]格式的值 */
//
...
(function($) {
	...
	$.fn.numberbox.parseOptions = function(_325) {
		var t = $(_325);
		return $.extend({},
		$.fn.validatebox.parseOptions(_325), {
			disabled: (t.attr("disabled") ? true: undefined),
		...
		return this.each(function() {
			...
			if (_347) {
				...
				_347 = $.data(this, "calendar", {
					options: $.extend({},
					$.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _345)
				});
				init(this);
			}
...
(function($) {
	...
	$.fn.spinner.parseOptions = function(_35e) {
		var t = $(_35e);
		return $.extend({},
		$.fn.validatebox.parseOptions(_35e), {
...
(function($) {
		...
		return this.each(function() {
			...
			if (_366) {
				...
				$.data(this, "numberspinner", {
					options: $.extend({},
					$.fn.numberspinner.defaults, $.fn.numberspinner.parseOptions(this), _363)
				});
			}
			_35f(this);
		});
	...
	$.fn.numberspinner.parseOptions = function(_368) {
		return $.extend({},
		$.fn.spinner.parseOptions(_368), $.fn.numberbox.parseOptions(_368), {});
	};
		...
		return this.each(function() {
			...
			if (_380) {
				...
				$.data(this, "timespinner", {
					options: $.extend({},
					$.fn.timespinner.defaults, $.fn.timespinner.parseOptions(this), _37d)
				});
				_369(this);
			}
		});
...
(function($) {
				...
				$("th", this).each(function() {
					...
					if (th.attr("editor")) {
						...
						if (s.substr(0, 1) == "{") {
							...
							/* 2011.06.28 liuhp修改： 支持读取window下的全局变量作为editor */
							
							col.editor = window[s] || s;
	...
	function _3c2(_3c3) {
		...
		body.find("div.datagrid-cell-check input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
		function(e) {
	...
	function _3d4(_3d5) {
		...
		_3d7.find("div.datagrid-cell").unbind(".datagrid").bind("click.datagrid",
		function() {
		...
		_3d7.find("input[type=checkbox]").unbind(".datagrid").bind("click.datagrid",
		function() {
			if (opts.singleSelect) {
				return false;
			}
		...
		_3db.children("div.datagrid-body").unbind(".datagrid").bind("scroll.datagrid",
		function() {
	...
	function _410(_411) {
		...
		/* 2011.06.29 修改：改正了同时删除多个新增项时的bug */
		//if (opts.idField) {
		if (false) {
	...
	function _42f(_430, _431) {
		...
		tr.find("div.datagrid-editable").each(function() {
			...
			/* 2011.06.29 修改，支持field="customer.name"格式*/
			ed.actions.setValue(ed.target, /*row[_433]*/ findObject(row, _433));
		});
		_434(_430, _431);
	};
	...
	var _4ef = {
		render: function(_4f0, _4f1, _4f2) {
			...
			/* 2011.06.30 修改：支持filed="customer.name"格式，保存row["customer.name"]格式的值 */
			// 查找带.的filed
			var cols = $(_4f0).datagrid("getColumnFields");
		...
		renderRow: function(_4fc, _4fd, _4fe, _4ff, _500) {
			...
			for (var i = 0; i < _4fd.length; i++) {
				...
				/* 2011.06.28 修改，支持field="customer.name"格式*/
				var val = findObject(_500, _502);
			
				var col = $(_4fc).datagrid("getColumnOption", _502);
				if (col) {
					var _503 = col.styler ? (col.styler(val, _500, _4ff) || "") : "";
					...
					if (col.checkbox) {
						...
						if (col.formatter) {
							cc.push(col.formatter(val, _500, _4ff));
						} else {
							cc.push(val);
						}
					}
...
(function($) {
	function _53d(_53e) {
		...
		$(_53e).datagrid("getPanel").find("div.datagrid-body").unbind(".propertygrid").bind("mousedown.propertygrid",
		function(e) {
			e.stopPropagation();
		});
		...
		return this.each(function() {
			...
			if (_546) {
				...
				$.data(this, "propertygrid", {
					options: $.extend({},
					$.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), _543)
				});
			}
			_53d(this);
		});
...
(function($) {
	...
	function _57d(_57e) {
		...
		body.find("div.datagrid-cell-check input[type=checkbox]").unbind(".treegrid").bind("click.treegrid",
		function(e) {
	...
	$.fn.treegrid = function(_5e0, _5e1) {
		...
		return this.each(function() {
			...
			if (_5e3) {
				...
				$.data(this, "treegrid", {
					options: $.extend({},
					$.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _5e0),
					data: []
				});
			}
			_560(this);
...
(function($) {
	...
	$.fn.combotree = function(_6a3, _6a4) {
		...
		return this.each(function() {
			...
			if (_6a6) {
				...
				$.data(this, "combotree", {
					options: $.extend({},
					$.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _6a3)
				});
			}
			_697(this);
		});
	...
	$.fn.combotree.parseOptions = function(_6a9) {
		return $.extend({},
		$.fn.combo.parseOptions(_6a9), $.fn.tree.parseOptions(_6a9));
	};
...
(function($) {
		...
		return this.each(function() {
			...
			if (_6c4) {
				...
				_6c4 = $.data(this, "combogrid", {
					options: $.extend({},
					$.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _6c1)
				});
			}
			_6aa(this);
		});
	...
	$.fn.combogrid.parseOptions = function(_6c7) {
		var t = $(_6c7);
		return $.extend({},
		$.fn.combo.parseOptions(_6c7), $.fn.datagrid.parseOptions(_6c7), {
	...
	$.fn.datebox = function(_6d8, _6d9) {
		...
		return this.each(function() {
			...
			if (_6db) {
				...
				$.data(this, "datebox", {
					options: $.extend({},
					$.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _6d8)
				});
			}
			_6c8(this);
		});
		...
		return this.each(function() {
			...
			if (_6f4) {
				...
				$.data(this, "datetimebox", {
					options: $.extend({},
					$.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _6f1)
				});
			}
			_6de(this);
		});
