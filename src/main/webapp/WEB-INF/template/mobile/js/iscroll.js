...
(function(window, doc) {
	...
	has3d = prefixStyle('perspective') in dummyStyle, hasTouch = 'ontouchstart' in window
			&& !isTouchPad, hasTransform = vendor !== false, hasTransitionEnd = prefixStyle('transition') in dummyStyle,
	...
	iScroll.prototype = {
		...
		_end : function(e) {
			...
			if (duration < 300 && that.options.momentum) {
				...
				newPosY = newPosY + momentumY.dist;
			//	alert(that.y + "===" + momentumY.dist)
